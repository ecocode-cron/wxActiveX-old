...
#ifndef _MOZILLAHTMLWIN_H_
#define _MOZILLAHTMLWIN_H_
...
enum wxMozillaHtmlRefreshLevel
{
	wxMOZILLAHTML_REFRESH_NORMAL = 0,
	wxMOZILLAHTML_REFRESH_IFEXPIRED = 1,
	wxMOZILLAHTML_REFRESH_CONTINUE = 2,
	wxMOZILLAHTML_REFRESH_COMPLETELY = 3
};

class IStreamAdaptorBase;

class wxMozillaHtmlWin : public wxActiveX
{
public:
    wxMozillaHtmlWin(wxWindow * parent, wxWindowID id = -1,
